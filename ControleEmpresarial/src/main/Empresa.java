...
public class Empresa {
	...
	protected double totalColaboradores = 0;
	...
	public void setDadosEmpresa(String nomeEmpresa, String cnpj, String dataInauguracao, double faturamentoAnualSede) {
	...
	public void getDadosEmpresa() {
		...
		if (this.balancoAnualEmpresa < 0) {
			System.out.println("A empresa " + this.nomeEmpresa + " teve faturamento negativo. Nomes dos sócios: ");
	...
	public static void main(String[] args) {
		...
		empresa01.setDadosEmpresa("Nome da empresa", "CNPJ", "00/00/0000", 00000);

		Empresa.Socios socio01 = empresa01.new Socios();
		socio01.setDadosSocios("Nome completo sócio 01", "000.000.000-00", "41997791016", "00/00/0000");

		Empresa.Socios socio02 = empresa01.new Socios();
		socio02.setDadosSocios("Nome completo sócio 02", "000.000.000-00", "41997791016", "00/00/0000");

		Empresa.Filiais filial01 = empresa01.new Filiais();
		filial01.setDadosFiliais("Nome da filial 01", "Nome responsável filial 01", 20000, "Endereço filial 01", "F01", "00/00/0000");

		Empresa.Filiais filial02 = empresa01.new Filiais();
		filial02.setDadosFiliais("Nome da filial 02", "Nome responsável filial 02", 30000, "Endereço filial 02", "F02", "00/00/0000");

		Empresa.Filiais filial03 = empresa01.new Filiais();
		filial03.setDadosFiliais("Nome da filial 03", "Nome responsável filial 03", 40000, "Endereço filial 03", "F03", "00/00/0000");
